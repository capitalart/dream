# FULL CODE STACK (THU-07-AUGUST-2025-12-51-AM)
...
<div class="workflow-row">
  <a href="{{ url_for('home.upload') }}" class="workflow-btn">
...
<!-- ========== [IN.1] Home Hero Section ========== -->
<div class="home-hero">
  <h1><img src="{{ url_for('static', filename='logos/logo-vector.svg') }}" alt="ArtNarrator Logo" class="artnarrator-logo"/>Welcome to ArtNarrator Listing Machine</h1>
  <p class="home-intro">
    G’day! Start in the Artwork section, analyze new pieces, review your AI-generated listings and mockups, and prep everything for marketplace export—all streamlined for you.
  </p>
</div>
    ...
    <div id="overlay-menu" class="overlay-menu">
        ...
        <nav class="overlay-nav">
            <div class="nav-column">
                ...
                <ul>
                    <li><a href="{{ url_for('home.upload') }}">Upload Artwork</a></li>
